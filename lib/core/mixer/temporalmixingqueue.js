...
function TemporalMixingQueue() {
  ...
  this.signatures = {};
  this.eventPairs = [];
  this.delayms = 25; // TODO: make this parametric
...
function handleDecodedRadioSignalPacket(instance, packet)
{
  ...
  if(isPayloadPresent) {
    ...
    // TODO: check that the source isn't already in the list
    //       if it is, emit what's there already and
    //       replace it with a new event pair and timestamp
  }
  else {

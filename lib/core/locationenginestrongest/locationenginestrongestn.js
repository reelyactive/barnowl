 ...
 * @param {Number} n The number of strongest decoders to consider.
 * @constructor
 */
function LocationEngineStrongestN(n) {
  var self = this;
  if(n != null) { this.n = n; } else { this.n = DEFAULT_N; }
 ...
 * of decodedRadioSignalPacketArray events.
 * @param {TemporalMixingQueue} emitter TemporalMixingQueue.
 */
